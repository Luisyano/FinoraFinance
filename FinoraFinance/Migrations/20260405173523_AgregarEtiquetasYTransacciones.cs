...
{
    /// <inheritdoc />
    public partial class AgregarEtiquetasYTransacciones : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Etiquetas_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transacciones_Etiquetas_EtiquetaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacciones_EtiquetaId",
                table: "Transacciones",
                column: "EtiquetaId");
